export const secrets: Record<string, string> = {
	...
	TheUnseenBladeDickInfo:
		"You know Dick. He's a run of the mill detective as far as you are concerned. He's solved a couple miracle cases, but anyone can do that. Not a threat.",
	IfATreeFallsFirstQuest:
	...
	ICanDoAllThisThroughHimWhoGivesMeStrengthSecondQuest:
	...
	ICanDoAllThisThroughHimWhoGivesMeStrengthDickInfo:
		'You know Richard. Detective. Pretty bad at his job all things considered. Seems to abuse alcohol, which is a sin.',
	TheMagicFluteFirstQuest:
	...
	ThePressIsFreeButLivingIsNotFirstQuest:
	...
	ThePressIsFreeButLivingIsNotSecondQuest:
	...
	ThePressIsFreeButLivingIsNotDickInfo:
